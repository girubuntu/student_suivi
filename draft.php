            ...
            <div class="mdk-header-layout__content mdk-header-layout__content--fullbleed mdk-header-layout__content--scrollable page"
                ...
                <div class="bg-white border-bottom mb-3">
                        <div class="container-fluid nav nav-tabs" role="tablist">
                            <a href="#permission"  data-toggle="tab" role="tab" aria-controls="activity_all" aria-selected="true">Permission</a>
                            <a href="#discipline-marks" data-toggle="tab" role="tab" aria-selected="false">Discipline Marks</a>
                            <a href="#course-marks" data-toggle="tab" role="tab"  class="active" aria-selected="false">Course Marks</a>
                      </div>
                    </div>
                <!-- <div class="bg-white border-bottom mb-3">
                </div> -->
                ...
                <div class="container-fluid page__container">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane  show fade" id="permission" style="margin-bottom: 7rem">
                            ...
                            <?php if(isset($_GET['success-permission'])){ ?>
                              ...
                              <?php } ?>
                                ...
                                <div class="col-md-12">
                                    <form action="" method="post">
                                        ...
                                        $queryStaff = "SELECT staff_role_id FROM staff WHERE id='$user_user_id' AND deleted != 'yes'";
										$queryStaff = $conn->query($queryStaff);
                                        $rowStaff = $queryStaff->fetch_assoc();
                                        $staffRoleId = $rowStaff['staff_role_id'];
                                        
                                        $queryStaffRole = "SELECT name FROM staffrole WHERE id='$staffRoleId' AND deleted != 'yes'";
										$queryStaffRole = $conn->query($queryStaffRole);
                                        $rowStaffRole = $queryStaffRole->fetch_assoc();
                                        $staffRole = $rowStaffRole['name'];
                                      
                                        if($staffRole == "discipline master"){ ?>
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    <label >Start date</label>
                                                    <input name="startDate" type="date" value="<?php echo date('Y-m-d'); ?>" class="form-control" >
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    <label >End date</label>
                                                    <input name="endDate" type="date" value="<?php echo date('Y-m-d'); ?>" class="form-control" >
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
                              ...
                              <div class="col-md-12">
                                    <table id="example" class="table table-bordered" style="width:100%; background:#46BEDB">
                                        ...
                                        <tbody>
                                        <?php
											$query = "SELECT * FROM permission WHERE student_id='$studentId' AND deleted != 'Yes'";
                        ...
                        <div class="tab-pane  show fade" id="discipline-marks" style="margin-bottom: 7rem">
                                ...
                                <div class="col-md-12">
                                    <table id="example" class="table table-bordered" style="width:100%; background:#FFCD5A">
                                        ...
                                        <tbody>
                                            <?php
                                            $totalMarks = 50;
                                                $query = "SELECT * FROM disciplinemarks WHERE student_id='$studentId' AND deleted != 'yes' ORDER BY created_on DESC";
                                                $query = $conn->query($query);
                                                $rows = $query->num_rows;
                                                    while($row = $query->fetch_assoc()){
                        ...
                        <div class="tab-pane active fade" id="course-marks" style="margin-bottom: 7rem">
                            ...
                            <?php if($role == 'staff'){ ?>
                                <div class="col-md-12">
                                    <form action="student-all-print.php" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label >Marks</label>
