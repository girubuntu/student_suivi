                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" value="<?php echo $studentId; ?>" alt="" name="studentId">
                                                </div>
                                            </div>
                            ...
                            <?php } ?>
                                <div class="col-md-12">
                                    <table id="example" class="table table-bordered" style="width:100%; background:#59BB4C">
                                        ...
                                        <?php
                                            $no = null;
											$query = "SELECT * FROM report WHERE student_id='$studentId'";
											$query = $conn->query($query);
												while($row = $query->fetch_assoc()){
                                                    $no++;
										?>
                                            <tr>
                                                <td><?php echo $no; ?></td>
                                                <td><?php echo "report " . $no; ?></td>
                                                <td><?php echo $row['created_on']; ?></td>
                                                <td><a href="report-print.php?report-id=<?php echo $row['id']; ?>">view</a></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
